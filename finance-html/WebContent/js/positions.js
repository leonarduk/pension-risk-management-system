...
xhr.onload = function() {// When readystate changes
	...
	for (var i = 0; i < responseObject.holdings.length; i++) {// Loop through object
		 ...
		 * amount   24475.88
		 ...
		 name    "CASH"
		 */
		newContent += '<tr><td>' + responseObject.holdings[i].instrument.name + '</td><td>' + responseObject.holdings[i].amount + '</td></tr>';
	}
