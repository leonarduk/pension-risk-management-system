...
public class LinearInterpolatorTest {
	...
	public void testInterpolate() {
		...
		Assert.assertEquals(Decimal.valueOf(102.75), actual.getTick(3).getClosePrice());
		Assert.assertEquals(Decimal.valueOf(103.5), actual.getTick(2).getClosePrice());
		Assert.assertEquals(Decimal.valueOf(104.25), actual.getTick(1).getClosePrice());
		Assert.assertEquals(Decimal.valueOf(102), actual.getTick(4).getClosePrice());
