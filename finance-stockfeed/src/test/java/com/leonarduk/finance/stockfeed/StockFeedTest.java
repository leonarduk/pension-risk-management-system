...
public class StockFeedTest {
	...
	private List<HistoricalQuote> getAlternateQuotes() {
		...
		series.add(new HistoricalQuote(Instrument.CASH, LocalDate.parse("2017-01-02"), BigDecimal.valueOf(11.3),
				BigDecimal.TEN, BigDecimal.valueOf(8.3), BigDecimal.valueOf(11.2), BigDecimal.valueOf(11.2), 13L,
				"TestCache"));
		return series;
	}
	...
	private List<HistoricalQuote> getQuotes() {
		final List<HistoricalQuote> series = Lists.newArrayList();
		series.add(new HistoricalQuote(Instrument.CASH, LocalDate.parse("2017-01-01"), BigDecimal.valueOf(12.3),
	...
	public final void testCreateStockInstrument() {
		...
		assertEquals(new Stock(Instrument.CASH), actual);
	}
	...
	public final void testMergeSeriesStockListOfHistoricalQuote() throws IOException {
		...
		assertEquals(2, stock.getHistory().size());
	}

	@Test
	public final void testMergeSeriesStockListOfHistoricalQuoteListOfHistoricalQuote() throws IOException {
		final Stock stock = StockFeed.createStock(Instrument.CASH, this.getQuotes());
