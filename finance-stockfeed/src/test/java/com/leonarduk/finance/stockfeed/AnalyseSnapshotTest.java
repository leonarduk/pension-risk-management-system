...
public class AnalyseSnapshotTest {
	...
	public void testCreateValuation() throws Exception {
		final Position position = new Position("", Instrument.UNKNOWN, Decimal.HUNDRED, Optional.empty(), null);
		final Tick lastTick = new Tick(LocalDate.parse("2017-04-13").toDateTimeAtCurrentTime(), 105.0, 115.0, 95.0,
				110.0, 20.0);
