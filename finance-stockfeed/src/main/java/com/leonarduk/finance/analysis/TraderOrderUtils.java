...
public class TraderOrderUtils {
	...
	public static class TradeWithStrategy extends Trade {
		...
		public TradeWithStrategy(final Order entry, final Order exit, final Strategy strategy,
		...
		@Override
		public String toString() {
			return "TradeWithStrategy [strategy=" + this.strategy + ", strategyName="
			        + this.strategyName + ", " + super.toString() + "]";
		}
	}

	public static List<Trade> getOrdersList(final List<Trade> trades, final TimeSeries series,
