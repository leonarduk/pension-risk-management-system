...
public class StockQuotesData {
	...
	public StockDividend getDividend() {
		...
		dividend.setAnnualYieldPercent(
				Utils.getBigDecimal(this.getValue(QuotesProperty.TrailingAnnualDividendYieldInPercent)));
	...
	public StockQuote getQuote() {
		...
		quote.setLastTradeTime(Utils.parseDateTime(this.getValue(QuotesProperty.LastTradeDate),
